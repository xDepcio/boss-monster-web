...
const { PlayerAlreadyDeclaredBuild, DungeonCardsStackEmpty, SpellCardsStackEmpty, CardCannotBeBuilt, DungeonFullError, BossCardStackEmpty, NoSuchBossInPlayerCards, PlayerAlreadySelectedBoss, InvalidFancyDungeonBuild, NoSuchDungeonInPlayerCards, WrongPhaseToBuild, PhaseNotFinished, PlayerAlreadyReady, PlayerAlreadyAcceptedHeroMove, CardCannotBeDestroyed, NoSuchDungeonCardInPlayerDungeon, WrongRoundPhase, NoSuchSpellInPlayerHand, OtherSpellCurrentlyAtPlay, PlayerAlreadyAcceptedSpellPlay, NoSpellCurrentylAtPlay, DungeonEffectCannotBeUsed, PlayerHasNotEnoughMoney, NoSuchHeroAtDungeonEntrance } = require('../errors');
